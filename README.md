...
This project focuses on data analysis using different statistical methodologies applied to a public dataset from a Portuguese banking institution's marketing campaign [Moro S., Rita P., Cortez P. (2014). Bank Marketing [Dataset] UCI Machine Learning Repository]. All analyses and models are developed independently.
